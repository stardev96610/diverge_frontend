...
const MyNavbar = ({ isSticky, navClass, buttonClass, fixedWidth, hideSearch }: MyNavbarProps) => {
        ...
        <header>
            ...
            >
                <Container fluid={!fixedWidth}>
                    ...
                    <Button variant='outline-primary' className="btn-rounded-circle btn-icon me-2 shadow-none login_btn">
                        Login / Register
                    </Button>
                </Container>
            </Navbar>
